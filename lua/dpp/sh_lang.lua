...
(this may cover possible exploits with non-default properties)
	...
	saveload_limits_models_removed = ' from model limits list for ',
	saveload_limits = ' limits for ',
	saveload_limits_models = ' model limits for ',
	...
	reset_blocklist_toolworld = 'TOOL WORLD BLOCK LIST RESET REQUIRED',
	reset_blocklist_damage = 'DAMAGE BLOCK LIST RESET REQUIRED',
	reset_blocklist_pickup = 'PICKUPS BLOCK LIST RESET REQUIRED',
	reset_blocklist_gravgun = 'GRAVITY GUN BLOCK LIST RESET REQUIRED',
	reset_excludelist_use = 'USE EXCLUDE LIST RESET REQUIRED',
	reset_excludelist_physgun = 'PHYSGUN EXCLUDE LIST RESET REQUIRED',
	reset_excludelist_tool = 'TOOL EXCLUDE LIST RESET REQUIRED',
	reset_excludelist_pickup = 'PICKUP EXCLUDE LIST RESET REQUIRED',
	reset_excludelist_property = 'PROPERTY EXCLUDE LIST RESET REQUIRED',
	reset_excludelist_gravgun = 'GRAVITY GUN EXCLUDE LIST RESET REQUIRED',
	reset_excludelist_propertyt = 'PROPERTY TYPE EXCLUDE LIST RESET REQUIRED',
	reset_excludelist_damage = 'DAMAGE EXCLUDE LIST RESET REQUIRED',
	reset_excludelist_toolmode = 'TOOL MODE EXCLUDE LIST RESET REQUIRED',
	reset_restrictlist_swep = 'SWEP RESTRICTIONS LIST RESET REQUIRED',
	reset_restrictlist_tool = 'TOOL RESTRICTIONS LIST RESET REQUIRED',
	reset_restrictlist_pickup = 'PICKUPS RESTRICTIONS LIST RESET REQUIRED',
	reset_restrictlist_vehicle = 'VEHICLE RESTRICTIONS LIST RESET REQUIRED',
	reset_restrictlist_property = 'PROPERTY RESTRICTIONS LIST RESET REQUIRED',
	reset_restrictlist_e2afunction = 'E2 ADVANCED FUNCTIONS RESTRICTIONS LIST RESET REQUIRED',
	reset_restrictlist_npc = 'NPCs RESTRICTIONS LIST RESET REQUIRED',
	...
	reset_command_total = ' has launched factory reset!',
	reset_command_excluded = ' has launched excluded lists factory reset!',
	reset_command_blocked = ' has launched blocked lists factory reset!',
	reset_command_restrictions = ' has launched restrictions lists factory reset!',
	reset_command_models = ' has launched models blacklist factory reset!',
	reset_command_limits = ' has launched entity limits list factory reset!',
	reset_command_mlimits = ' has launched model limits list factory reset!',
	...
	reset_command_blocked_toolworld = ' has launched tool world blocklist factory reset!',
	reset_command_blocked_damage = ' has launched damage blocklist factory reset!',
	reset_command_blocked_pickup = ' has launched pickups blocklist factory reset!',
	reset_command_blocked_gravgun = ' has launched gravity gun blocklist factory reset!',
	reset_command_exclude_use = ' has launched use exclude list factory reset!',
	reset_command_exclude_physgun = ' has launched physgun exclude list factory reset!',
	reset_command_exclude_tool = ' has launched tool exclude list factory reset!',
	reset_command_exclude_pickup = ' has launched pickups exclude list factory reset!',
	reset_command_exclude_property = ' has launched property exclude list factory reset!',
	reset_command_exclude_gravgun = ' has launched gravity gun exclude list factory reset!',
	reset_command_exclude_propertyt = ' has launched property type exclude list factory reset!',
	reset_command_exclude_damage = ' has launched damage exclude list factory reset!',
	reset_command_exclude_toolmode = ' has launched tool mode exclude list factory reset!',
	reset_command_restrictions_swep = ' has launched SWEP restriction list factory reset!',
	reset_command_restrictions_tool = ' has launched tool restriction list factory reset!',
	reset_command_restrictions_pickup = ' has launched pickups restriction list factory reset!',
	reset_command_restrictions_vehicle = ' has launched vehicle restriction list factory reset!',
	reset_command_restrictions_property = ' has launched property restriction list factory reset!',
	reset_command_restrictions_e2afunction = ' has launched E2 Advanced Function restriction list factory reset!',
	reset_command_restrictions_npc = ' has launched NPCs restriction list factory reset!',
	...
	reset_gui_btoolworld = 'Reset toolgun world blocklist',
	reset_gui_bdamage = 'Reset damage blocklist',
	reset_gui_bpickup = 'Reset pickups blocklist',
	reset_gui_bgravgun = 'Reset gravity gun blocklist',
	reset_gui_euse = 'Reset use exclude list',
	reset_gui_ephysgun = 'Reset physgun exclude list',
	reset_gui_etool = 'Reset tool exclude list',
	reset_gui_epickup = 'Reset pickups exclude list',
	reset_gui_eproperty = 'Reset property exclude list',
	reset_gui_egravgun = 'Reset gravity gun exclude list',
	reset_gui_epropertyt = 'Reset property type exclude list',
	reset_gui_edamage = 'Reset damage exclude list',
	reset_gui_etoolmode = 'Reset tool mode exclude list',
	reset_gui_rswep = 'Reset SWEP restrictions list',
	reset_gui_rtool = 'Reset tool restrictions list',
	reset_gui_rpickup = 'Reset pickups restrictions list',
	reset_gui_rvehicle = 'Reset vehicle restrictions list',
	reset_gui_rproperty = 'Reset property restrictions list',
	reset_gui_re2afunction = 'Reset E2 Advanced Functions restrictions list',
	reset_gui_rnpc = 'Reset NPCs restrictions list',
	reset_gui_rsent = 'Reset SENTs restrictions list',
	reset_gui_re2function = 'Reset E2 Functions restrictions list',
	reset_gui_rmodel = 'Reset models restrictions list',
}
...
(может закрыть возможные уязвимости в нестандартных свойствах)
	...
	cvar_restrict_npc_ply = 'Включить ограничения для определнных игроков на NPC',
	cvar_restrict_pickup_ply = 'Включить ограничения для определнных игроков на Подбираемые',
	cvar_restrict_property_ply = 'Включить ограничения для определнных игроков на Свойства',
	cvar_restrict_sent_ply = 'Включить ограничения для определнных игроков на Энтити',
	cvar_restrict_swep_ply = 'Включить ограничения для определнных игроков на Оружия',
	cvar_restrict_tool_ply = 'Включить ограничения для определнных игроков на Инструменты',
	cvar_restrict_vehicle_ply = 'Включить ограничения для определнных игроков на Транспорт',
	menu_restrictions_ply = 'Ограничения на Игрока',
	plyrestrict_already_not_restricted = 'Данный класс не ограничен для данного игрока!',
	plyrestrict_already_restricted = 'Данный класс уже ограничен для данного игрока!',
	plyrestrict_from = ' от игрока ',
	priv_restricte2afunction_ply = 'Может ли добавлять ограничения в лист функции Expression 2 Advanced по игроку',
	priv_restricte2function_ply = 'Может ли добавлять ограничения в лист Expression 2 Advanced по игроку',
	priv_restrictmodel_ply = 'Может ли добавлять ограничения в лист моделей по игроку',
	priv_restrictnpc_ply = 'Может ли добавлять ограничения в лист NPC по игроку',
	priv_restrictpickup_ply = 'Может ли добавлять ограничения в лист подбираемые по игроку',
	priv_restrictproperty_ply = 'Может ли добавлять ограничения в лист свойств по игроку',
	priv_restrictsent_ply = 'Может ли добавлять ограничения в лист Энтити по игроку',
	priv_restrictswep_ply = 'Может ли добавлять ограничения в лист оружий по игроку',
	priv_restricttool_ply = 'Может ли добавлять ограничения в лист инструментов по игроку',
	priv_restrictvehicle_ply = 'Может ли добавлять ограничения в лист транспорта по игроку',
	priv_touchworld = 'Whatever player can touch world props',
	priv_unrestricte2afunction_ply = 'Может ли удалять ограничения из листа функции Expression 2 Advanced по игроку',
	priv_unrestricte2function_ply = 'Может ли удалять ограничения из листа Expression 2 Advanced по игроку',
	priv_unrestrictmodel_ply = 'Может ли удалять ограничения из листа моделей по игроку',
	priv_unrestrictnpc_ply = 'Может ли удалять ограничения из листа NPC по игроку',
	priv_unrestrictpickup_ply = 'Может ли удалять ограничения из листа подбираемые по игроку',
	priv_unrestrictproperty_ply = 'Может ли удалять ограничения из листа свойств по игроку',
	priv_unrestrictsent_ply = 'Может ли удалять ограничения из листа Энтити по игроку',
	priv_unrestrictswep_ply = 'Может ли удалять ограничения из листа оружий по игроку',
	priv_unrestricttool_ply = 'Может ли удалять ограничения из листа инструментов по игроку',
	priv_unrestrictvehicle_ply = 'Может ли удалять ограничения из листа транспорта по игроку',
	remove_r = 'Удалить ограничение',
	restrict_ctip = 'Ограничить для группы выше',
	restricted_e2afunction_mode = 'Expression 2 Advanced функции',
	restricted_e2function_mode = 'Expression 2 функции',
	restricted_model_mode = 'Модель',
	restricted_npc_mode = 'NPC',
	restricted_pickup_mode = 'Подбираемые',
	restricted_property_mode = 'Свойства',
	restricted_sent_mode = 'Энтити',
	restricted_swep_mode = 'Оружия',
	restricted_tool_mode = 'Инструменты',
	restricted_vehicle_mode = 'Транспорт',
	...
	cvar_transfer_all = 'Разрешать игрокам передавать все их энтити',
	cvar_transfer_all_disc = 'Разрешать игрокам использовать овнер феллбек',
	cvar_transfer_buddies = 'Разрешать игрокам передавать энтити только друзьям (не касается админов)',
	cvar_transfer_enable = 'Разрешить игрокам передавать что либо',
	cvar_transfer_single = 'Разрешить игрокам передавать единичное энтити',
	eedit_limit = 'Редактировать лимит...',
	fpp_buddies = 'Найдено %s друзей в списке FPP!',
	fpp_buddies_i = 'Нажмите тут для импорта друзей из FPP',
	friend_added_fpp = 'Добавлен %s как друг из списка FPP',
	menu_mlimits = 'Лимиты моделей',
	model_limit_hit = 'Вы достигли лимита по %q!',
	model_limit_note = 'NOTE: This just prevents the player from spawning\nmodels with the given model if the player spawned\n the given amount of props within this model.\nThat means it DOES NOT allow groups to spawn\n unlimited amounts of props within that\nmodel.',
	priv_addmodellimit = 'Может ли добавлять лимит моделей',
	priv_removemodellimit = 'Может ли удалять лимит моделей',
	saveload_glimit_not_exists = 'Лимит для группы не существует',
	saveload_limits_models = ' лимиты моделей для ',
	saveload_limits_models_removed = ' лимиты не существуют для ',
	saveload_mlimit_not_exists = 'Лимит для модели не существует',
	transfer_adisabled = 'Передача всего сразу не разрешена',
	transfer_buddy = 'Передача разрешена только друзьям',
	transfer_disabled = 'Передача чего либо не разрешена',
	transfer_edisabled = 'Передача единичного энтити не разрешена',
	transfer_fdisabled = 'Овнер феллбек был отключён владельцем сервера',
	transfer_spam = 'СПАМ ПЕРЕДАЧЕЙ!',
