...
local ru = {
	...
	cvar_apropkill_clampspeed = 'Уменьшать максимальную скорость физгана',
	...
	cvar_blacklist_physgun_white = 'Чёрный лист физгана является белым списком.',
	...
	cvar_can_admin_physblocked = 'Могут ли админы использовать физган на заблокированных энтити',
	...
	cvar_disable_unfreeze = 'Отключить разморозку физганом (Перезарядка)',
	...
	cvar_enable_physgun = 'Включить защиту физгана',
	...
	cvar_prevent_prop_throw = 'Не давать игрокам швырять пропы физганом',
	...
	cvar_unfreeze_antispam = 'Предотвращать спам размораживания физганом',
	cvar_unfreeze_antispam_delay = 'Минимальная задержка перед попытками разморозить',
	cvar_unfreeze_restrict = 'Ограничить разморозку физганом',
	...
	cvar_whitelist_physgun = 'Включить лист исключений физгана',
