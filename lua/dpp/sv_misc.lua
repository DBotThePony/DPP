...
local function KillAPAnti()
	...
	hook.Remove('PhysgunPickup', 'APAntiPickup')
	hook.Remove('PhysgunDrop', 'APAntiDrop')
	hook.Remove('OnEntityCreated', 'APAntiGhostSpawn')
	hook.Remove('PlayerUnfrozeObject', 'APAntiGhostR')
	hook.Remove('CanProperty', 'APA.CanPropertyFix')
	hook.Remove('EntityTakeDamage', 'APAntiPk')
	hook.Remove('PlayerSpawnedProp', 'APAntiExplode')
	hook.Remove('OnEntityCreated', 'APAntiSpawns')
	hook.Remove('PlayerSpawnObject', 'APAntiSpawns')
	hook.Remove('AllowPlayerPickup', 'APAntiPickup')
	hook.Remove('PhysgunPickup', 'APAIndex')
	hook.Remove('PhysgunDrop', 'APANoThrow')
	hook.Remove('OnPhysgunReload', 'APAMassUnfreeze')
	timer.Remove('APAUnGhostPassive')
	timer.Remove('APAFreezePassive')
	
	DPP.Message('----------------------------------------')
	DPP.Message('APAnti has been detected and has been disabled!')
	DPP.Message('Reason: Tons, TONS of Bugs from APAnti side, like')
	DPP.Message('Ghosting entities when players TRY but not PICKING UP them')
	DPP.Message('All the bugs Entriely kills DarkRP, because when player try')
	DPP.Message('to touch any blacklisted entity, it gets ghosted. Forever.')
	DPP.Message('From DBot: For me this is really bad addon. Really, this is the worst')
	DPP.Message('anti prop kill ever maded. If you really need anti prop kill, enable')
	DPP.Message('this features in DPP.')
	DPP.Message('----------------------------------------')
end
